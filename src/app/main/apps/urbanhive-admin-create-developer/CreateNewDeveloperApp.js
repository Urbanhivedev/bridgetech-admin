...
import CreateNewDeveloperForm from './components/CreateNewDeveloperForm';


function CreateNewDeveloperApp() {
  return (
    <FusePageSimple
      header={
...
export default CreateNewDeveloperApp;
